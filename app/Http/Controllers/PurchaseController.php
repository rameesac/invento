...
class PurchaseController extends Controller
{
    ...
    {
        return Purchase::with('supplier:id,name', 'purchase_details:id,purchase_id,product_id,quantity,cost,rate,discount,net_amount', 'purchase_details.product:name,id')
        ->orderBy('id', 'desc')
        ->get();
    }
